(() => {
    ...
    async function loadSitemapData() {
        ...
        try {
            ...
            showLoading(50);
            buildTree(state.originalUrls, {}, 'url', true); // Start with tree expanded
            showLoading(100);
    ...
    function buildTree(urls, filter = {}, sortBy = 'url', expandAll = false) {
        ...
        const sortedRoots = Object.keys(hierarchy).sort((a, b) => a.localeCompare(b));
        ...
        state.isTreeExpanded = expandAll; // Update state based on expandAll
    ...
    function exportHtmlReport() {
        ...
        const reportHtml = `
            ...
            <body>
                ...
                <script>
                    // Add interactivity to toggle elements
    ...
    function exportCsvReport() {
        ...
        const rows = state.originalUrls.map(({ loc, lastmod, changefreq, priority }) =>
